...
public interface IOrdersService
{
  ...
  /// <summary>
  /// Returns matching orders as OrderResponse objects
  /// </summary>
  /// <param name="filter">Expression that represents condition to check</param>
  /// <returns>Returns matching orders as OrderRespose objects</returns>
  ...
  /// <returns>Returns OrderResponse object that contains order details after inserting;
  /// or returns null if insertion is unsuccessful.
  /// </returns>
